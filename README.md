...
| `uplink-transfer.yml` | Dispatch to move a patch between queues; merge of a transfer PR runs `--complete`; close without merge deletes both branches |
