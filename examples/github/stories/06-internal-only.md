...
Open a PR. On the **Open pull request** page, add label `uplink:internal-only` **before** you click Create (Uplink PR checks only see labels that exist when the check runs). Wait for product checks. Merge.
